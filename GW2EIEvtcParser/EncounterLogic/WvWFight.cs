    ...
    internal class WvWFight : FightLogic
    {
        ...
        protected override CombatReplayMap GetCombatMapInternal(ParsedEvtcLog log)
        {
            ...
            switch (mapID.MapID)
            {
                // EB
                case 38:
                    return new CombatReplayMap("../cache/images/https_i.imgur.com_7DnLZ7G.png", (3100,3250),(-36864, -36864, 36864, 36864), (-36864, -36864, 36864, 36864), (8958, 12798, 12030, 15870));
                // Green Alpine
                case 95:
                    return new CombatReplayMap("../cache/images/https_i.imgur.com_s4wMYgZ.png", (2492, 3574), (-30720, -43008, 30720, 43008), (-30720, -43008, 30720, 43008), (5630, 11518, 8190, 15102));
                // Blue Alpine
                case 96:
                    return new CombatReplayMap("../cache/images/https_i.imgur.com_s4wMYgZ.png", (2492, 3574), (-30720, -43008, 30720, 43008), (-30720, -43008, 30720, 43008), (12798, 10878, 15358, 14462));
                // Red Desert
                case 1099:
